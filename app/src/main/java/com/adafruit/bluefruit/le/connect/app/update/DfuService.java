...
public class DfuService extends DfuBaseService {
	...
	protected Class<? extends Activity> getNotificationTarget() {
		/*
		 * As a target activity the NotificationActivity is returned, not the MainActivityDraw. This is because the notification must create a new task:
		 * 
		 ...
		 * this application - the MainActivityDraw. However if nRF Beacon has been closed during upload and user click the notification a NotificationActivity will
		 * be launched as a root activity. It will create and start the MainActivityDraw and finish itself.
		 * 
